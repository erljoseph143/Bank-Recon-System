...
class BankaccountController extends Controller
{
    ...
    public function view(Request $request) {
        ...
        $companies = BankAccount::groupBy('bankaccount.company_code')->get();

        //dd($companies);

        $bus = Businessunit::all();

        return view('admin.bankaccount.home', compact('accounts', 'title', 'pagetitle', 'countall', 'counttrash', 'doctitle', 'login_user_firstname', 'companies', 'bus'));
    }
    ...
    public function postReq(Request $request) {
        ...
        if ($request->p == 'getbu') {
            ...
            $bus = BankAccount::where('company_code', $request->id)
                ->groupBy('bankaccount.buid')
                ->get();

//            dd(DB::getQueryLog());
            return view('admin.bankaccount.buselect', compact('bus'));

        } elseif ($request->p == 'getacc') {

            $accs = BankAccount::where('buid', $request->id)
                ->get(['id', 'bankno', 'bank', 'accountno', 'accountname', 'status']);

            return view('admin.bankaccount.table', compact('accs'));
    ...
    public  function allTrashAccounts() {
        ...
        return view('admin.bankaccount.index', compact('accounts', 'title', 'doctitle', 'pagetitle', 'countall', 'date', 'template', 'counttrash', 'banks', 'login_user_firstname'));
