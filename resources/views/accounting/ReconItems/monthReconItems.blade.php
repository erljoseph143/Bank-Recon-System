                    ...
                    <div class="widget-body no-padding">
                        ...
                        <table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
                            ...
                            @foreach($arrayData as $data)
                                <tr>
                                    <td>{{date("F, Y", strtotime($data[0]))}}</td>
                                    <td>{{$data[1]}}</td>
                                    <td>{{$data[2]}}</td>
                                    <td>{{$data[3]}}</td>
                                    <td>
                                        {{--<a href='#ajax/recon_items.php?bank_no=$bank_no&end_date=$var_month[1]&bankname=$bankname&bankacctname=$bankacctname&bankacctno=$bankacctno&bu_unit=$bu_unit&user_id=$user_id&start_date=$var_month[0]'>--}}
                                        <a href='#{{base64_encode($data[0]."/".$data[5]."/".$data[1]."/".$data[2]."/".$data[3]).csrf_token().base64_encode("BRS")}}' class="reconItemsList">
