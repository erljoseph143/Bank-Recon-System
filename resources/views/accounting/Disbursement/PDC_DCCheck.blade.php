        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-1" data-widget-editbutton="false">
                ...
                <header role="heading">
                    ...
                    <h2>Post Dated and Dated Checks </h2>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
                            ...
                            @foreach($disBook as $disBK)
                                @php
                                    $cvYear  = date("Y",strtotime($disBK->cv_date));
                                    $cvMonth = date("n",strtotime($disBK->cv_date));
                                    $checkYear  = date("Y",strtotime($disBK->check_date));
                                    $checkMonth = date("n",strtotime($disBK->check_date));
                                    if(($cvMonth < $checkMonth and $cvYear == $checkYear) or ($cvMonth > $checkMonth and $cvYear < $checkYear))
                                    {
                                        $status ="PDC";
                                    }
                                    else
