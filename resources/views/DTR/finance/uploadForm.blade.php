        ...
        <div class="form-group">
            <div class="col-md-12 margin-top-10">
                <label for="file" class="btn btn-default fileinput-button">
                    ...
                    <input id="file" type="file" name="dtr" style="display: none" required>
                </label>
...
<script>
    ...
    function DTRupload(){
        ...
        var bankYear = $('#year').val();
        if(bank.match(/BPI/))
        {
            if(bpiType.match(/EXPLINK/))
            {
                console.log("express");
            }
            else
            ...
            else if(bankYear=='' && bpiType.match(/EXPLINK/))
            {
                BootstrapDialog.alert('Plese select a year!');
            }
            ...
            else if(com!='' && bu!='' && bankAcct!='' && numFiles!=0 && bpiType!='')
            {
