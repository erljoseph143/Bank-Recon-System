<div class="my-pnl">
    ...
    <div class="my-pnl-body">
        <form id="search-form" action="{{ route('ledgers.index') }}">
            <div class="radio radio-primary">
                <input type="radio" name="plradio" id="code" value="ledger_code" checked="">
                <label for="code"> code </label>
            </div>
            <div class="radio radio-primary">
                <input type="radio" name="plradio" id="name" value="ledger_name" checked="">
