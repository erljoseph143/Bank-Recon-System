    ...
    <div class="tab-content bankborder">
        <div class="tab-pane active" id="tab112">
            <div class="span6" style="padding:20px;">
                ...
                <span style="font-size: 25px;">&nbsp;Uploading Deposit Excel</span>


                <form method="post" action="depExcel/depUploader" accept-charset="UTF-8" name="actionsend" enctype="multipart/form-data">
                    {{csrf_field()}}
