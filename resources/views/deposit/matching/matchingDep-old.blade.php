        ...
        <form action="" method="">
            ...
            <div class="wizard-navigation">
                <ul>
                    ...
                    {{--<li><a href="#branchCode" data-toggle="tab">Match By Branch Code</a></li>--}}
            ...
            <div class="tab-content">
                ...
                {{--<div class="tab-pane" id="brachCode">--}}
            ...
            <div class="wizard-footer">
                <div class="pull-right">
                    ...
                    <a href="{{url('deposit/depExcel')}}" class="btn btn-success hidden btn-excel">
