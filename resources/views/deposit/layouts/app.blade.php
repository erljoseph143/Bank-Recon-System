...
<head>
    <meta charset="utf-8"/>
    <title>Accounting Deposit Matching</title>
    ...
    <div class="page-header-inner">
        ...
        <div class="page-top">
            ...
            <div class="col-md-6" style="height: inherit;color:white;text-align:left;padding:24px">
               {{\Illuminate\Support\Facades\Auth::user()->businessunit->company->company}} : {{\Illuminate\Support\Facades\Auth::user()->businessunit->bname}}
            </div>
...
<div class="page-container">
    ...
    <div class="page-sidebar-wrapper">
        ...
        @include('deposit.layouts.sidebar')
        <!-- END SIDEBAR MENU -->
        </div>
    </div>
    <!-- END SIDEBAR -->
...
@include('DTR.finance.layouts.js');
