                        ...
                        <div class="jarviswidget" id="wid-id-0" data-widget-togglebutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false">
                            ...
                            <header>
                                ...
                                <ul class="nav nav-tabs pull-right in" id="myTab">
                                    <li class="active">
                                        <a data-toggle="tab" href="#s1"><i class="fa fa-clock-o" style="color:black"></i> <span class="hidden-mobile hidden-tablet" style="color:black">Book Disbursement Records</span></a>
                                    </li>

                                    <li>
                                        <a data-toggle="tab" href="#s2" ><i class="glyphicon glyphicon-fullscreen" style="color:black"></i> <span class="hidden-mobile hidden-tablet" style="color:black">Bank Disbursement Records</span></a>
                                    </li>
