                    ...
                    <div class="widget-body no-padding">
                        ...
                        <table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
                            ...
                            <tr>
                                ...
                                <th data-hide="phone">Date Today</th>
...
$book->label_match] ;                           --}}
                            @foreach($disBook as $disBK)
                                <tr>
                                    <td>{{$disBK[0]}}</td>
                                    <td>{{date("m/d/Y",strtotime($disBK[1]))}}</td>
                                    <td>{{date("m/d/Y",strtotime($disBK[2]))}}</td>
                                    <td>{{date("m/d/Y")}}</td>
                                    <td>{{$disBK[3]}}</td>
                                    <td>{{$disBK[4]}}</td>
                                    <td style="text-align: right;">{{number_format($disBK[5],2)}}</td>
                                    <td>
                                        {{--{{$disBK[6]}}--}}Stale Check
                                    </td>
                                </tr>
