<table id="pending-data" class="table table-striped table-bordered table-hover dataTable no-footer" >
    <thead>
    <tr>
        <th>TCPOF #</th>
        ...
        <tr>
            ...
            <td>
                @if($data->cpo_status =='approve')
                    Approve <i id="{{$data->id}}" class="glyphicon glyphicon-print print" style="cursor:pointer"></i>
                @else
...
<script>
    $("#pending-data").DataTable({"aaSorting": []});
</script>