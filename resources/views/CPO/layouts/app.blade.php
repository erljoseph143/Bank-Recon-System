    ...
    <div class="page-header-inner">
        ...
        <div class="page-top">
            ...
            <div class="col-md-6" style="height: inherit;color:white;text-align:left;padding:24px">
                {{$ses->businessunit->company->company ." : ". $ses->businessunit->bname }} {{ strtolower($auth)=='cash pull out'?" : ". $ses->department->dep_name : "" }}
            </div>
...
<script src="{{ url('logbook/amtTOwords/jquery.num2words.js') }}" type="text/javascript"></script>
<script>
