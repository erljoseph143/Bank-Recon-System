<template>
    <div>
        <tabs>
            ...
            <tab title="Tabular">
                <!--{{monthOf}}-->
                <monthly-table  :month="monthOf" :year="yearOf"></monthly-table>
            </tab>
        </tabs>

        <modal v-model="showModal" :title="bankAcct" size="lg modal-full" :backdrop="false">
            <bank-table v-if="tableShow" :dateSelected="dateSelected" :datas="datasOf" :header="headerOf" :bankof="bankName"></bank-table>
        </modal>
    </div>
</template>
