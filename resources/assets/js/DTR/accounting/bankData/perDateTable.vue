<template>
    <div>
        <table id="bank-table" class="table table-condensed table-hover" :selectedDate="dateSelected">
            <thead>
            <tr>
                <th v-for="(head, index) in header">{{head}}</th>
            </tr>
            </thead>
            <tbody>
...
<script>
    export default
    {
        props:['dateSelected','datas','header','bankof'],
